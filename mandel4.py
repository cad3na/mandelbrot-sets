...
crearFractal(-0.75, -0.734375, -0.125, -0.11875, imagen, 250)

ax = pylab.imshow(imagen, cmap="YlOrRd")
...
fig = pylab.gcf()
fig.savefig("mandel4.png", dpi=300, pad_inches=0.0, bbox_inches='tight', figsize=(20,8))