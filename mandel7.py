...
crearFractal(inicio_x, fin_x, inicio_y, fin_y, imagen, 256)

ax = pylab.imshow(imagen, cmap="Paired")
...
fig = pylab.gcf()
fig.savefig("mandel7.png", dpi=300, pad_inches=0.0, bbox_inches='tight', figsize=(16,9))
