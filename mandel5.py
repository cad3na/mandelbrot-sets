...
crearFractal(-0.85, -0.834375, -0.225, -0.21875, imagen, 250)

ax = pylab.imshow(imagen, cmap="YlGnBu")
...
fig = pylab.gcf()
fig.savefig("mandel5.png", dpi=300, pad_inches=0.0, bbox_inches='tight', figsize=(20,8))