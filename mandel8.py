...
crearFractal(inicio_x, fin_x, inicio_y, fin_y, imagen, 200)

ax = pylab.imshow(imagen, cmap="gist_heat")
...
fig = pylab.gcf()
fig.savefig("mandel8.png", dpi=300, pad_inches=0.0, bbox_inches='tight', figsize=(16,9))
